...
public final class Constants {
  public static final class DriveConstants {
    ...
    //AlgaeIntake
    public static final int AlgaeManipulaterCanId = 8;  // Replace with your actual CAN ID
    public static final int AlgaeIntakeRotationCanId = 7;          // Replace with your actual CAN ID
    //CoralIntake
  ...
  public static final class OIConstants {
    ...
    public static final double kManipulatorDeadband = 0.05;
  }
